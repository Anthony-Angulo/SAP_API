    ...
    public class ApplicationDbContext : IdentityDbContext<User, IdentityRole, string>
    {
        ...
        */
        ...
        public enum Series : int
        {
            ...
            S01_CEDIS = 4,
            S05_PACHUCO = 77,
            S06_CENTRAL_DE_ABASTOS = 78,
            S08_BARULIO_MALDONADO = 79,
            S10_TIJUANA_OTAY = 82,
            S12_SAN_LUIS_MAYOREO = 84,
            S15_MAYOREO_BELLAVISTA = 86,
            S17_BRULIO_FyV = 87,
            S24_MAYOREO_ENSENADA = 90,
            S36_TIJUANA_20_NOVIEMBRE = 97,
          //  S47_MAYOREO_LAZARO = 353,
           // S49_CENTRAL_DE_ABARROTES = 355,
            S53_PLANTA_PROCESADORA = 105,
           // S55_PARQUE_MORELOS = 361,
            S59_TIJUANA_MATAMOROS = 108,
            S62_ANAHUAC_MAYOREO = 111,
            S70_BENITEZ = 924,
            //  S63_MAYOREO_BUENA_VISTA_TJ = 1768,
            S73_SAN_QUINTIN = 1215,
